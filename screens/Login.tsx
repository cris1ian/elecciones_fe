...
import {
  PuntoMuestral,
  PuntoMuestralRaw,
} from "../models/punto-muestral.model";
  ...
  const onClickReportarPresencia = async () => {
    if (!celular)
      return createTwoButtonAlert(
        "Error",
        "No se ingresó un código o celular válido"
      );
    ...
    if (resp === undefined)
      return createTwoButtonAlert(
        "Error",
        "El nro de celular ingresado es incorrecto"
      );
    ...
    if (currentRegistroIngreso)
      return createTwoButtonAlert("Error", "Usted ya reporto su presencia");
  ...
  const onClickIngresar = async () => {
    ...
    if (
      ...
      const navigateTo: string =
        puntoMuestral.idTipo === tiposPuntosMuestrales.TD ? `Home` : `Reports`;
      ...
      <View style={styles.subContainer}>
        ...
        <View style={styles.buttonContainer}>
          <Button
            ...
            title="Reportar presencia"
            type="outline"
            onPress={onClickReportarPresencia}
            disabled={!celular}
            loading={spinner}
          />
        </View>
